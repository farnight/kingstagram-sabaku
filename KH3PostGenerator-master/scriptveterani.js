...
/*** FORM FUNCTIONS ***/
//load character list
$.get('https://raw.githubusercontent.com/farnight/kingstagram-sabaku/main/KH3PostGenerator-master/List/characterveterani.txt', function(data) {
...
function generate() {
	...
	if (iOS) $('.prvdownload').val('Save As Image to Download');
...
function getchara(id) {
	...
	else 
	{
		...
		prof = 'Images/Avatars/' + charas[$(id).val()]["File"];
	}
}
